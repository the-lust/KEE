...
#error \
This platform expected a `eos_<platform>m_base.h` include before this header. \
...
#ifndef EOS_CALL
#if defined(_WIN32) && (defined(__i386) || defined(m_M_IX86))
...
Please refer to https://dev.epicgames.com/docs/services or `eos_platform_prereqs.h` for details.
	...
	#elif defined(_MSC_VER) && defined(m_MSVC_LANG) && m_MSVC_LANG >= 201103L
		#define EOS_HAS_ENUM_CLASS
	#endif
#else
...
#include "eos_callback_ids.h"

#define EOS_STRUCT(struct_name, struct_def)           \
	EOS_EXTERN_C typedef struct m_tag ## struct_name {     \
		EOS_PASTE struct_def                          \
        static constexpr int k_iCallback = EOS_GET_CALLBACK_ID(struct_name); \
	} struct_name
...
#define EOS_ENUM_END(name) , __##name##m_PAD_INT32__ = 0x7FFFFFFF } name
#endif
